          ...
          <p>
            {showFullDate
              ? content[details.releaseDate]
                ? new Date(content[details.releaseDate]).toLocaleDateString(
                    'en-US',
                    {
                      month: 'short',
                      day: 'numeric',
                ...
                : content[details.releaseDateTv] &&
                  new Date(content[details.releaseDateTv]).toLocaleDateString(
                    'en-US',
                    {
                      month: 'short',
                      day: 'numeric',
          ...
          <div className='flex items-start justify-between mb-2'>
            ...
            <div className='flex-shrink-0 md:hidden'>
              <span className='text-yellow-400 text-xs font-medium'>
                {Number(content?.[details.rating].toFixed(1))}
              </span>
            </div>
          </div>
