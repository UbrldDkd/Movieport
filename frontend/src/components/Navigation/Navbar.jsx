...
import NavProfile from './authModal/NavProfileDropdown.jsx';
...
export default function Navbar() {
  ...
  return (
    <div className='relative'>
      <nav className='top-0 left-0 w-full bg-red-950 shadow-md z-50 h-16 px-4'>
              ...
              {user ? (
                ...
                <>
                  <button
                    ...
                    className='bg-red-950 hover:bg-red-900 text-zinc-200 px-4 py-1 rounded text-sm'
                  >
                    Log in
                  </button>
                  ...
                  <button
                    onClick={() =>
                      handleOpen('authModal', true) ||
                      setActiveAuthTab('register')
                    }
                    className='bg-zinc-600 hover:bg-zinc-500 text-zinc-200 px-4 py-1 rounded text-sm'
                  >
                    Register
                  </button>
                </>
      ...
      <button
        ...
        className='md:hidden text-zinc-400 p-2 rounded-b-3xl hover:bg-gradient-to-b hover:from-red-950 hover:to-red-900 transition relative z-50'
      >
        <svg
