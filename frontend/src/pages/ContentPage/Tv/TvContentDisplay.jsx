...
export default function TvContentDisplay({ seasonContent, id, episodeNumber }) {
  ...
  return (
    <div className='w-full py-4'>
      <div className='grid justify-center items-center gap-3 grid-cols-3'>
        {' '}
        {seasonContent.episodes.map((ep) => (
          <Link
            ...
            className={`
              relative group px-2 py-1.5 text-sm md:text-base rounded-sm cursor-pointer
              ...
              ${
                episodeNumber === ep.episode_number
                  ...
                  : 'bg-zinc-900/90 text-zinc-400 hover:bg-zinc-900 active:bg-zinc-700 active:text-zinc-300'
              }
            `}
          >
