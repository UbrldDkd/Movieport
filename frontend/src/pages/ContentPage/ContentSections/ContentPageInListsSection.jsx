import ListCard from '../../../pages/Profile/ProfileBrowse/Lists/ListCard';
...
export default function ContentPageInListsSection({ lists = [], isLoading }) {
  ...
  return (
    <div className='mt-8'>
      <h2 className='text-lg font-semibold text-zinc-300/90'>
        Popular featuring lists
      </h2>
      <div className='mt-2 mb-3 h-0.25 bg-zinc-600' />
      <div className='flex flex-col gap-4'>
        {displayLists.slice(0, 4).map((list) => (
          ...
          >
            <ListCard list={list} posterAmount={3} />
          </div>
        ))}
      </div>
