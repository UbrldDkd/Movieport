export default function Placeholder({ onAdd }) {
  return (
    <div className='w-full aspect-2/3 bg-zinc-800 hover:border-zinc-700  rounded-sm flex items-center justify-center cursor-pointer border-2 border-zinc-700/20 shadow-lg shadow-zinc-950  transition-all duration-150'>
