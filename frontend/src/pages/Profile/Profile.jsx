...
export default function Profile() {
  ...
  if (isLoading || !userToDisplay) {
    return (
      <div className="min-h-screen bg-zinc-950 text-zinc-200 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="text-zinc-400">{isLoading ? 'Loading...' : 'User not found'}</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200">
      <motion.div
        className="mx-auto w-full max-w-[1120px] px-4 sm:px-6 md:px-8 lg:px-12 pb-8 flex flex-col "
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        <motion.div variants={sectionVariants}>
          <div className="flex flex-col md:flex-row gap-6">
            ...
            {/* Optional right column for extra widgets */}
