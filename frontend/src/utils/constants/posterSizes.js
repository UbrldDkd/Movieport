export const posterSizes = {
  ...
  lg: {
    width: 'min-w-[113px] max-w-[132px]  lg:min-w-[150px] lg:max-w-[150px]',
    tmdb: 'w500',
  },

  xl: {
    width:
      'min-w-[121px] max-w-[1px] sm:min-w-[160px] sm:max-w-[160px] md:min-w-[180px] md:max-w-[180px] lg:min-w-[220px] lg:max-w-[220px]',
    tmdb: 'w780',
  },

  sectionLg: {
    width: 'min-w-[118px] max-w-[132px]  lg:min-w-[150px] lg:max-w-[150px]',
    tmdb: 'w500',
  },

  similarSection: {
    width:
      'min-w-[95px] max-w-[82px] sm:min-w-[95px] sm:max-w-[95px] md:min-w-[100px] md:max-w-[100px] lg:min-w-[114px] lg:max-w-[114px]',
    tmdb: 'w500',
  },
  mobileContentPoster: {
    width: 'min-w-[135px] lg:max-w-[120px]',
